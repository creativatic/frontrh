    ...
    template: `
        <aside class="hr-sidebar">
            ...
            <nav class="hr-sidebar-nav">
                <!-- Group: Operación -->
                <div *ngIf="hasPermission('ver_colaboradores') || hasPermission('ver_contratos') || hasPermission('ver_asistencia')" class="hr-nav-group-label">Operación</div>
                
                <a *ngIf="hasPermission('ver_colaboradores') || hasPermission('ver_contratos') || hasPermission('ver_asistencia')" class="hr-nav-item" routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }">
                    <span class="icon">
                ...
                <a *ngIf="hasPermission('ver_colaboradores')" class="hr-nav-item" routerLink="/colaboradores" routerLinkActive="active">
                    <span class="icon">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a *ngIf="hasPermission('ver_contratos')" class="hr-nav-item" routerLink="/contratos" routerLinkActive="active">
                    <span class="icon">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Group: Control Biométrico / Scanner -->
                <div *ngIf="hasPermission('acceso_scanner')" class="hr-nav-group-label">Control Biométrico</div>
                <a *ngIf="hasPermission('acceso_scanner')" class="hr-nav-item" routerLink="/asistencia/scanner" routerLinkActive="active">
                    <span class="icon">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
